...
String to_email = "akashkumarkoiri@gmail.com";  // The email address to send the message to
String to_sms = "91number@airtelap.com"; // Look up your carrier's Email-to-SMS gateway here: https://martinfitzpatrick.name/list-of-email-to-sms-gateways/
